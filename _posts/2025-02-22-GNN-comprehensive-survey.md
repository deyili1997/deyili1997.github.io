...
![The general design pipeline for a GNN model]({{site.baseurl}}/images/post_3_1.png)
*The general design pipeline for a GNN model.*

![An overview of computational modules]({{site.baseurl}}/images/post_3_2.png)
*An overview of computational modules.*

![An overview of variants considering graph type and scale]({{site.baseurl}}/images/post_3_3.png)
