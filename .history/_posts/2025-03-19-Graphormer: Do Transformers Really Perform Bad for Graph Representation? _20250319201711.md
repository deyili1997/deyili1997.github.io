...
2. Spatial encoding
They proposed to use a bias term to adjust the attention scores (before softmax). For one node attending to other nodes, the shortest path between a pair of nodes is computed, then 